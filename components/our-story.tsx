...
export function OurStory() {
  return (
    <section id="histoire" className="scroll-mt-32 bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-[1600px] px-6 sm:px-10 lg:px-[5.8vw]">
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-4 text-center">
          ...
          <h2 className="font-heading text-4xl leading-[0.98] tracking-[-0.02em] text-[#171715] sm:text-5xl">
            À l&apos;origine d&apos;
            <span className="text-[#aa6a12]">Harmony Cure</span>
          </h2>
        ...
        <div className="mx-auto mt-10 max-w-5xl sm:mt-14">
          <p className="font-heading text-2xl text-center leading-relaxed text-[#171715] italic sm:text-3xl">
            ...
            simple&nbsp;: aider d&apos;autres femmes à retrouver confiance,
            éclat et harmonie dans leur vie quotidienne. »
          </p>
          ...
          <div className="grid gap-10 sm:grid-cols-5 sm:gap-6">
            {MILESTONES.map(({ title, text }) => (
              <div className="flex flex-col gap-3 text-center" key={title}>
                ...
                <p className="text-sm leading-relaxed text-[#585750]">{text}</p>
              </div>
            ))}
          </div>
        </div>
